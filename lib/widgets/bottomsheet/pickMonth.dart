...
import 'package:MyCompany/repos/cupertinoDatePicker/flutter_cupertino_date_picker.dart';
...
pickMonth(BuildContext context, DateTime startTime) async {
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    DatePickerWidget(
                      ...
                      initialDateTime: startTime != null
                          ? startTime
                          : DateTime.now().minute < 30
                          ? DateTime(
                          DateTime.now().year,

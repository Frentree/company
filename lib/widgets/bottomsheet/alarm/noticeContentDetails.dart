            ...
            children: [
              FutureBuilder(
                future: FirebaseRepository().photoProfile(
                    user.companyCode,
                    comment.createUser['mail'].toString()),
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
              ...
              children: [
                InkWell(
                  child: Text(
                    word.enterComments(),
                    style: customStyle(
                        fontColor: blueColor, fontSize: 10.0.sp, fontWeightName: 'Medium'),
                  ),
                  onTap: () {
                    setState(() {
                      crudType = 1;
                ...
                return ConfigurableExpansionTile(
                  ...
                  children: <Widget>[
                    Container(
                      width: 100.0.w,
                      child: Column(
                        children:commentsDoc.map((data) => getCommentsList(
                            context: context,
                            document: data,
                            noticeID: noticeID,
                            user: user,
          ...
          Row(
            ...
            children: [
              ...
              FutureBuilder(
                future: FirebaseRepository().photoProfile(
                    user.companyCode,
                    comments.commentsUser['mail'].toString()),
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return Icon(Icons.person_outline);
                  }

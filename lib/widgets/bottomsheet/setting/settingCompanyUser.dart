...
import 'package:MyCompany/widgets/bottomsheet/setting/settingCompanyUserDetail.dart';
...
SettingCompanyUser({BuildContext context, double statusBarHeight}) {
  User _loginUser;
          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                emptySpace,
                Expanded(
                  child: SettingCompanyUserDetailPage(),
                ),
              ],
            ),
          );

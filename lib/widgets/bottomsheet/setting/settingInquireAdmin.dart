...
import 'package:MyCompany/widgets/bottomsheet/setting/settingInquireAdminDetail.dart';
...
SettingInquireAdmin({BuildContext context, double statusBarHeight}) {
  double heightSize;
  showModalBottomSheet(
      ...
      builder: (context) {
        heightSize = MediaQuery.of(context).size.height - 10.0.h - statusBarHeight;
              ...
              return Container(
                ...
                child: Column(
                  children: [
                    ...
                    emptySpace,
                    Expanded(
                      child: SettingInquireAdminDetail(),
                    ),
                  ],
                ),
              );

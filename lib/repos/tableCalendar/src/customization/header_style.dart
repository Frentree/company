...
class HeaderStyle {
  ...
  const HeaderStyle({
    ...
    this.leftChevronPadding = const EdgeInsets.only(right: 0),
    this.rightChevronPadding = const EdgeInsets.only(left: 0),
    this.leftChevronMargin = const EdgeInsets.only(right: 0),
    this.rightChevronMargin = const EdgeInsets.only(left: 0),

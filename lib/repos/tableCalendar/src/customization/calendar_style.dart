...
class CalendarStyle {
  ...
  final TextStyle outsideSaturdayStyle;
  ...
  const CalendarStyle({
    ...
    this.saturdayStyle = const TextStyle(color: const Color(0xFF2196F3)),
    ...
    this.outsideSaturdayStyle = const TextStyle(color: const Color(0xFF90CAF9)),

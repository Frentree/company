...
int _getWeekdayNumber(StartingDayOfWeek weekday) {
  return StartingDayOfWeek.values.indexOf(weekday) + 2;
}
...
class _TableCalendarState extends State<TableCalendar>
  ...
  Widget _buildTable() {
    ...
    double weekEndColumnWidth = 0.005;
        ...
        child: Row(
          children: <Widget>[
            ...
            child: Table(
              ...
              columnWidths: {
                5: FractionColumnWidth(weekEndColumnWidth),
                6: FractionColumnWidth(weekEndColumnWidth)
              },
              defaultColumnWidth: FractionColumnWidth(0.5 / daysInWeek),
              children: children,
            ),
          ),
            SizedBox(

...
class _TableCalendarState extends State<TableCalendar> with SingleTickerProviderStateMixin {
    ...
    return ClipRect(
      child: Column(
        children: [
          ...
          widget.headerStyle.formatButtonVisible ? _buildFormatButton() : Container()
        ],
      )
    );
  }
  ...
  TableRow _buildDaysOfWeek() {
    return TableRow(
      ...
      children: widget.calendarController._visibleDays.value.take(7).map((date) {
        ...
        final isSaturday = widget.calendarController._isSaturday(date);
  ...
  Widget _buildCellContent(DateTime date) {
    ...
    final tIsSaturday = widget.calendarController._isSaturday(date);
    ...
    final isOutsideSaturday = widget.builders.outsideWeekendDayBuilder != null && tIsOutside && tIsSaturday && !tIsHoliday;
    ...
    final isSaturday = widget.builders.weekendDayBuilder != null && !tIsOutside && tIsSaturday && !tIsHoliday;
    ...
    } else if (isOutsideWeekend || isOutsideSaturday) {

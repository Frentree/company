...
Widget getUpdateMyInfomationCard({BuildContext context, User user}){
  ...
  TextEditingController _passwordConfirmTextCon = TextEditingController();
        ...
        Row(
          children: [
            ...
            ActionChip(
              ...
              onPressed: () {
                String pwdMsg = _loginRepository.validationRegExpCheckMessage(field: "비밀번호", value: _passwordConfirmTextCon.text.trim());
                print(pwdMsg);
                if(_passwordConfirmTextCon.text.trim() == ""){
                  showDialog(
                    context: context,
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          FlatButton(
                            ...
                            onPressed: () {
                              _loginRepository.InfomationUpdateWithFirebaseAuth(context: context, mail: user.mail, name: user.name, password: _passwordConfirmTextCon.text.trim());
                              Navigator.pop(context);
                            },
                          ),
                          FlatButton(

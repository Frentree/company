          ...
          Padding(
              ...
              child: Column(
                children: [
                  Container(
                    child: FutureBuilder(
                      future: _db.collection('company')
                          .document(_loginUser.companyCode)
                          .collection("notice").where("caseSearch", arrayContains: content).getDocuments(),
                      builder: (context, snapshot) {
                        ...
                        return Column(
                          children: [
                            _seachTitleCon.text.trim() != "" ? Text.rich(
                              TextSpan(
                                text: _seachTitleCon.text,
                                style: customStyle(
                                  fontSize: 12,
                  ...
                  Container(
                    child: FutureBuilder(
                      future:_db.collection('company')
                          .document(_loginUser.companyCode)
                          .collection("work").where("caseSearch", arrayContains: content).getDocuments(),

            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(
                          "자동 로그인",
                          style: customStyle(15*MediaQuery.of(context).textScaleFactor, "Regular", top_color),
                        ),
                      ],
                    ),
                  ),
                  ...
                  textBtn("회원가입", customStyle(15*MediaQuery.of(context).textScaleFactor, "Regular", top_color), () => loginScreenChangeProvider.setPageIndex(1)),
